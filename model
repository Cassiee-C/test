...
class PatchInflated(nn.Module):
    ...
    def __init__(self, in_chans, embed_dim, input_resolution, stride=5, padding=0, output_padding=0):
        ...
        self.Conv = nn.ConvTranspose2d(in_channels=embed_dim, out_channels=in_chans, kernel_size=(5, 5),
...
class SwinLSTM(nn.Module):
    def __init__(self, img_size, patch_size, in_chans, embed_dim=128, depths_downsample=[2, 6], depths_upsample=[6, 2], num_heads=[4, 8],
                 window_size=3):
